...
const aboutText: Record<Locale, AboutText> = {
  ja: {
    title: 'まずは、ホッキョクグマの暮らしを知る',
    lead: '専門知識がなくても読めるように、基本情報を短くまとめました。',
    items: [
      {
        title: 'どこにいる？',
        body: 'カナダ、グリーンランド、ノルウェー、ロシア、アラスカ周辺に生息しています。地域ごとに状況が異なるため、個体群ごとに観察されています。',
      },
      {
        title: 'どうやって食べる？',
        body: '主な獲物はアザラシです。海氷の上で、静かに狩りの機会を待ちます。',
      },
      {
        title: '子育ては？',
        body: '母グマは雪の巣穴で出産し、子グマは数年かけて生きる力を身につけます。',
      },
      {
        title: '体の特徴は？',
      ...
      {
        title: '泳ぎは得意？',
        body: '長距離を泳ぐ力があります。ただ、泳ぐ時間が長いほど体力を消耗するため、海氷は欠かせません。',
      },
      {
        title: '寿命は？',
        body: '野生では20〜25年ほどとされています。子グマは2年以上、母グマと行動をともにします。',
      },
    ],
  },
  en: {
